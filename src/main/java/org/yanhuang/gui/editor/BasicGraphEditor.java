...
public class BasicGraphEditor extends JPanel {
	...
	static {
		try {
			// only rendering text with English
			mxResources.getBundles().addFirst(new PropertyResourceBundle(mxResources.class.getResourceAsStream(
					"/guiconfig/editor.properties")));
//			mxResources.add("/guiconfig/editor");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
